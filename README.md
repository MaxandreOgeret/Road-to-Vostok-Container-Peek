...
Aiming, or firing an equipped primary or secondary weapon, closes the window for the current container. The window stays hidden for that container until you look away and then look back at it, so weapon handling is not obstructed by the preview.
